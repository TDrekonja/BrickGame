...
function start(){
	zacelo++;
	if(zacelo==1){
	document.getElementById("spodnji").visibility="none";
	document.getElementById("zgornji").visibility="none";
	zakleni++;
	var konc=false;
	document.body.style.background= "url('slike/source2.1.gif') center";
                    ...
                    if(x > b.x && x < b.x+brickWidth && y > b.y && y < b.y+brickHeight) {
                        ...
                        if(score == brickRowCount*brickColumnCount) {
							...
							if(zmaga==2){
								...
								start2();*/
								/*document.getElementById("bton2").style.visibility=" visible";
    ...
    function drawScore() {
        ctx.font = "16px Lakers";
        ctx.fillStyle = "#09b08e";
        ctx.fillText("Score: "+score, 8, 20);
    }
	function drawScore2() {
        ctx2.font = "16px Lakers";
        ctx2.fillStyle = "#0095DD";
